...
UPDATE `mifostenant-default`.`m_image` SET `location`='images/client_image/ppatel.jpg' WHERE `id`='4';
UPDATE `mifostenant-default`.`m_image` SET `location`='images/client_image/pshah.jpg' WHERE `id`='5';
UPDATE `mifostenant-default`.`m_image` SET `location`='images/client_image/rkrangiya.jpg' WHERE `id`='6';