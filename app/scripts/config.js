...
app.constant('PAGE_URL', {
    ...
    VIEW_REPORTS_ACCOUNTING : '/vreports/accounting',
    VIEW_REPORTS_CLIENTS : '/vreports/clients',
    VIEW_REPORTS_LOANS : '/vreports/loans',
    VIEW_REPORTS_MIS : '/vreports/mis',
    VIEW_REPORTS_ALL : '/vreports/all',
        ...
        LOAN: [
            {
                ...
                expression: 'json.get("principal").getAsInt() >= {0} && json.get("principal").getAsInt() <= {1}',
                defaults: {
                    min: 0,
                    max: 10000
                },
