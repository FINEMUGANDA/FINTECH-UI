    ...
    .directive('datepick', ['dateFilter', '$parse', 'datepickerConf', '$log', function (dateFilter, $parse, datepickerConf, $log) {
        return {
            ...
            template: '<table role=\"grid\" aria-labelledby=\"{{uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n' +
                ...
                '      <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button id=\"{{uniqueId}}-title\" role=\"heading\" aria-live=\"assertive\" aria-atomic=\"true\" type=\"button\" class=\"btn btn-default btn-sm\" ng-click=\"toggleMode()\" tabindex=\"-1\" style=\"width:100%;\"><strong>{{title}}</strong></button></th>\n' +
                ...
                '      <td ng-show=\"showWeekNumbers\" class=\"text-center h6\"><em>{{ getWeekNumber(row) }}</em></td>\n' +
