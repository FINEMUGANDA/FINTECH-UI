        ...
        function ($scope, APPLICATION, REST_URL, RoleService) {
            ...
            $scope.save = function () {
                var saveSuccess = function () {
                    var loanOfficerId = angular.copy($scope.formData.toLoanOfficerId);
                    _.forEach(Object.keys($scope.formData.clients), function(clientId) {
                        RoleService.updateData(REST_URL.CREATE_CLIENT + '/' + clientId, {
